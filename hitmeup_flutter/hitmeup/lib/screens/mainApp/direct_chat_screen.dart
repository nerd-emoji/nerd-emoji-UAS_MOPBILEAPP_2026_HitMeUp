...
class _DirectChatScreenState extends State<DirectChatScreen> {
  ...
  // ✅ FIX: hapus ChatDataProvider
  List<Map<String, dynamic>> get _messages {
    return [
      {
        'id': '${widget.chat.id}_001',
                ...
                child: Stack(
                  children: [
                    ...
                    ListView(
                      ...
                      children:
                          _messages.map((msg) => _buildMessage(msg)).toList(),
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildAttachItem(IconData icon, String label) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
            color: AppColors.pinkTop.withOpacity(0.4),
            width: 1),
      ),
      child: Row(
        children: [
